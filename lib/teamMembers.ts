...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    school: 'Boston University Academy',
    graduationYear: '‘27',
    profilePic: 'joshuafl.png',
    role: 'Communications Associate',
    bio: 'Joshua is a senior at BU Academy. He started teaching as a math instructor for a year before becoming a Communications Associate. He enjoys teaching at gbSTEM as well as being a camp counselor in summer. When he is not teaching or being a student, Joshua loves playing frisbee, spending time with friends, and learning chess.',
    team: 'outreach',
  },
  {
    name: 'Allen Yu',
  ...
  },
  {
    ...
    role: 'Math Co-Director',
    bio: 'Sudeep is a junior at Northwestern University studying biomedical engineering and neuroscience. He has taught math, computer science, and engineering courses at gbSTEM. Through his role as a math director, he hopes to design engaging curricula that sparks a love for problem-solving. In his free time, he likes to teach, play badminton, and try new food.',
    team: 'math',
  },
  {
    name: 'Leila Koplan',
