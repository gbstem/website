  ...
  return (
    <div className="container mb-5">
      <p style = {{fontSize:"1.25rem"}}>
        ...
        <p>The spring semester will run from Sunday, March 16th to Saturday, June 14th. <br/> Instructor applications and student signups for the spring semester opened on Sunday, February 9th. <br/><br/> Class enrollment is on a first-come, first-served basis and will open on Saturday, March 8th. You must first sign up through the portal before March 8th in order to enroll in classes when enrollment opens. 
