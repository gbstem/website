  ...
  return (
    <div className="container">
      ...
      <div className="mx-auto mb-20 flex w-fit flex-wrap items-stretch justify-center justify-items-stretch gap-12">
        <Card className="d-flex flex-column align-items-center w-2xs max-w-full p-4 text-center shadow-[1px_2px_2px_2px_rgba(20,20,20,0.4)]">
          ...
          <Button href="/reports/gbstem-impact.pdf" className="mt-8 w-fit text-base!">
