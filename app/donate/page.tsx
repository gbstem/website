...
function Donate() {
  return (
    ...
    <div className="container" >
      ...
      <a type="button" className="btn btn-primary mb-4"
      ...
      <div className="container" style = {{fontSize:"1.5rem", paddingLeft:"5rem", paddingRight:"7rem", textAlign:"center", margin:"auto"}}>
  <div className="row" style = {{borderColor:"black", borderWidth:"0px", borderStyle:"solid"}}>
    <div style = {{borderWidth:"1px", width: "10rem"}}></div>
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid", backgroundColor:"#eeeeee", boxShadow:"0px 0px 5px black"}}>
    ...
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid", alignItems:"baseline", backgroundColor:"#5CBF60", boxShadow:"0px 0px 5px black"}}>
    <div style = {{ display: "flex", height: "100%", alignItems:"end", justifyContent:"center"}}>
    <div style = {{display: "block"}}>
    ...
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid", alignItems:"baseline", backgroundColor:"#ffd809", boxShadow:"0px 0px 5px black"}}>
    <div style = {{ display: "flex", height: "100%", alignItems:"end", justifyContent:"center"}}>
    <div style = {{display: "block"}}>
    ...
    <div className="col sm" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid", alignItems:"baseline", backgroundColor:"#67aeda", boxShadow:"0px 0px 5px black"}}>
    <div style = {{ display: "flex", height: "100%", alignItems:"end", justifyContent:"center"}}>
    <div style = {{display: "block"}}>
    ...
    <div className="col"style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}>X</div></div>
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}>X</div></div>
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid", height:"10rem"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}>X</div></div>
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}>X</div></div>
    <div className="w-100"></div>
    ...
    <div className="col"style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid", height:"10rem"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}></div></div>
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}>X</div></div>
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}>X</div></div>
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center",color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}>X</div></div>
    <div className="w-100"></div>
    ...
    <div className="col"style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}></div></div>
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}></div></div>
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}>X</div></div>
    <div className="col" style = {{borderColor:"black", borderWidth:"1px", borderStyle:"solid", height:"10rem"}}><div style = {{height: "100%", display:"flex", alignItems:"center", justifyContent:"center", color:"#1d2256", fontSize:"5rem", fontWeight:"600"}}>X</div></div>
    <div className="w-100"></div>
