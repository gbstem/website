    ...
    <div className="container">
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Your Logo on gbSTEM Merchandise
            </div>
          </div>
          <div
            className="col"
          ...
          >
            ...
            >
              Annual Feature on gbSTEM Social Media
            </div>
          </div>
          <div
            className="col"
      ...
      <ol style={{ listStyleType: 'square' }}>
        <li style={{ marginBottom: '1rem' }}>
          <strong>Maintain our Website:</strong> Your generosity helps us keep our website up and
          running, serving as a valuable resource for students, parents, and educators.
        </li>
        <li style={{ marginBottom: '1rem' }}>
          <strong>Secure In-Person Venues:</strong> We believe in the power of in-person interaction
          for effective STEM education. Your donations enable us to secure suitable venues where
          students can engage in hands-on learning activities.
        </li>
        <li style={{ marginBottom: '1rem' }}>
        ...
        <li style={{ marginBottom: '1rem' }}>
          ...
          exciting prizes that inspire and motivate students at our events.
        </li>
        <li style={{ marginBottom: '1rem' }}>
          <strong>Access Necessary Software:</strong> Staying at the forefront of STEM education
          requires the use of up-to-date software. Your contributions assist us in acquiring the
          software needed to enhance our programs and initiatives.
        </li>
        <li style={{ marginBottom: '1rem' }}>
          <strong>Thank Our Hardworking Instructors!</strong> We thank our instructors for their
          dedicated work each year with free gbSTEM merchandise.
        </li>{' '}
      </ol>
