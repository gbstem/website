...
const description =
  'Math III begins building the foundations of algebra. After solidifying their multiplication and division skills, students will begin solving algebraic equations and more complicated word problems. Math III will also introduce more advanced decimal and fraction concepts, and area, perimeter, and volume for complex shapes. This will be a somewhat faster-paced course than Math II, so each student is ensured to receive lots of individualized support.';
const prerequisites =
  'Students taking this class should be comfortable with the majority of topics covered in Math II, especially 2-digit multiplication, basic long division, area and perimeter of basic shapes and solids, and 1-Step and 2-Step equations.';
const slides: string[] = [];
