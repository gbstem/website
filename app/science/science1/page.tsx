...
const prerequisites =
  'We recommend this course for anyone who is passionate about or wants to learn more about environmental issues and design forward-thinking solutions. Students taking this course should be comfortable with basic graphing and be able to read and understand simple equations.';
const slides = [
  process.env.PUBLIC_URL + '/science/coral.jpeg',
  process.env.PUBLIC_URL + '/science/oxbow.jpg',
  process.env.PUBLIC_URL + './science/snail.jpg',
];
const slideCaptions = ['', '', ''];
