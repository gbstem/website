...
const returnLink = '/cs';
const description =
  'Scratch 3 is a project-based exploration course in Scratch where students design and build larger original projects that integrate the core concepts learned in previous Scratch classes.';
...
const modules = [
  ...
  'Interactive systems and polish',
