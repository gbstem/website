...
const returnLink = '/cs';
const description =
  'Python 3 introduces students to software development workflows and algorithmic problem solving through larger Python projects and collaborative coding practices.';
const prerequisites =
  'Offered according to instructor availability and student interest. Prerequisite: Python 2.';
const slides: string[] = [];
const slideCaptions: string[] = [];
const modules = [
  'Introductory software development practices',
