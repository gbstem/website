      ...
      <div className="container pb-5 pt-5">
        <div className="row">
          <div className="col-md-6">
            ...
            <Link href="/faq" className="text-decoration-none btn btn-primary" style = {{display: "flex", alignItems:"center"}}>
              Learn More<ArrowRight/>
            </Link>

            <div>
              <Link href="/team" className="text-decoration-none btn btn-primary"  style = {{display: "flex", alignItems:"center"}}>
